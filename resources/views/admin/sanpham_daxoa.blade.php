                                ...
                                <tbody>
                                    ...
                                    @foreach ($sanpham_arr as $sp)
                                        <tr data-id="{{ $sp->id }}">
                                            ...
                                            <td>
                                                <a href="sanphamde/khoi-phuc/{{ $sp->id }}" class="btn btn-primary btn-sm">Khôi phục</a>


                                            </td>
                                            <td>
                                                <a href="sanphamde/xoa-vinh-vien/{{$sp->id}}" class="btn btn-danger btn-sm" onclick="return confirm('Xác nhận Xóa vĩnh viễn?')">Xóa vĩnh viễn</a>
                                            </td>
